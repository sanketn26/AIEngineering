---
description: A 90-day track shipping an SLM-powered stock research assistant with time-safe splits, RAG citations, and measured compression, not trading advice.
---
